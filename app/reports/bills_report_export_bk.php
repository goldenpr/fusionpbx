...
//export as a PDF
	if (permission_exists('reports_export_pdf') && $export_format == 'pdf') {
		...
		$data_end = '</table>';
		$data_head = '<tr>';
		$data_head .= '<td width="22%"><b>'.$text['label-domain'].'</b></td>';
		$data_head .= '<td width="22%"><b>'.$text['label-name'].'</b></td>';
		$data_head .= '<td width="10%"><b>'.$text['label-month'].'</b></td>';
		$data_head .= '<td width="8%"><b>'.$text['label-sdate'].'</b></td>';
		$data_head .= '<td width="8%"><b>'.$text['label-edate'].'</b></td>';
		$data_head .= '<td width="10%" align="center"><b>'.$text['label-calls'].'</b></td>';
		$data_head .= '<td width="10%" align="center"><b>'.$text['label-in-minutes'].'</b></td>';
