...
//get the post variables
	...
	if (count($_POST) > 0 && strlen($_POST["persistformvar"]) == 0) {
		...
		//redirect the browser
			header("Location: time_condition_edit2.php?id=".$dialplan_uuid.($app_uuid != '' ? "&app_uuid=".$app_uuid : null));
			exit;
...
function add_custom_condition($destination, $group_id, $dialplan_action = '') {
	...
	echo "						</td>\n";
	echo "						<td style='display:none' width='100%'><input class='formfld' style='margin-left: 5px;' type='text' name='group_".$group_id."' id='group_".$group_id."' maxlength='255' value=\"".$group_id."\"></td>\n";
	echo "					</tr>";
	echo "				</table>\n";
	echo "			</td>\n";
	echo "		</tr>\n";
...
//if presets exist, show the preset section
	if (isset($available_presets) && sizeof($available_presets) > 0) {
		...
		echo "	<br />\n";
		echo "	<table style='display:none' border='0' cellpadding='2' cellspacing='0' style='margin: -2px;'>\n";
		echo "		<tr>";
		echo "			<td>";
