...
$text['message-transfred']['en-us'] = "Transfred destination detected";
$text['message-transfred']['en-gb'] = "Transfred destination detected";
$text['message-transfred']['ar-eg'] = "تم اكتشاف وجهة تم تحويلها";
$text['message-transfred']['de-at'] = "Zielort erkannt"; // translated from "Transfred destination detected"
$text['message-transfred']['de-ch'] = "Zielort erkannt"; // translated from "Transfred destination detected"
$text['message-transfred']['de-de'] = "Zielort erkannt"; // translated from "Transfred destination detected"
$text['message-transfred']['es-cl'] = "Destino transfred detectado";
$text['message-transfred']['es-mx'] = "Destino transfred detectado"; // copied from es-cl
$text['message-transfred']['fr-ca'] = "Destination transfred détectée"; // copied from fr-fr
$text['message-transfred']['fr-fr'] = "Destination transfred détectée";
$text['message-transfred']['he-il'] = "זוהתה יעד טרנספרד";
$text['message-transfred']['it-it'] = "Destinazione transfred rilevata";
$text['message-transfred']['nl-nl'] = "Transfred-bestemming gedetecteerd";
$text['message-transfred']['pl-pl'] = "Wykryto cel transfred";
$text['message-transfred']['pt-br'] = "Destino transfred detectado";
$text['message-transfred']['pt-pt'] = "Destino transfred detectado";
$text['message-transfred']['ro-ro'] = "Destinație transfred detectată";
$text['message-transfred']['ru-ru'] = "Обнаружено место назначения transfred";
$text['message-transfred']['sv-se'] = "Transfred destination upptäckt";
$text['message-transfred']['uk-ua'] = "Виявлено трансферне місце призначення";
$text['message-transfred']['tr-tr'] = "Transfred hedefi tespit edildi";
$text['message-transfred']['zh-cn'] = "检测到转发目的地";
$text['message-transfred']['ja-jp'] = "転送先が検出されました";
$text['message-transfred']['ko-kr'] = "전송된 목적지가 감지되었습니다";
